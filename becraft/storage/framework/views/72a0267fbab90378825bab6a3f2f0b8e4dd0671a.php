...
unset($__errorArgs, $__bag); ?>" name="deskripsi_game"><?php echo e(old('deskripsi_game')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="deskripsi_field"><?php echo e(old('deskripsi_field')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-lg-10 mt-1 d-flex align-items-center">
        ...
        <div class="form-check">
            <input type="radio" id="radioCustom" name="serverOption" class="form-check-input" value="custom">
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($datas->deskripsi_game); ?></td>
                                <td><?php echo e($datas->deskripsi_field); ?></td>
                                <td>
...
<?php echo $__env->make('main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamesho1/gameshop.asia/becraft/resources/views/components/admin/kategori.blade.php ENDPATH**/ ?>