        ...
        <div class="content-body">
            ...
            <div class="">
              <div class="row">
                <div class="col-md-3 col-lg-4 p-4">
                    <img src="<?php echo e(url('')); ?><?php echo e(!$config ? '' : $config->logo_footer); ?>" alt="LOGO" class="logo-bawah w-50">
                    <div class="mt-2 ratakirikanan">
                        <p>Top Up Game Favoritmu termurah hanya di <?php echo e(ENV('APP_NAME')); ?>, seperti Top Up Mobile Legends, Top Up FF (Free Fire) dan Top Up Game Favoritmu lainnya dengan proses cepat dan otomatis</p>
                    </div>
                </div>
         ...
         <div class="col-md-3 col-lg-2 p-4">
          ...
          <div class="mt-3">
           ...
           <i class="fab fa-instagram"></i><a href="<?php echo e(!$config ? '' : $config->url_ig); ?>" target="_blank" class="text-white text-decoration-none"> Instagram</a><br>
           <i class="fab fa-facebook"></i><a href="<?php echo e(!$config ? '' : $config->url_fb); ?>" target="_blank" class="text-white text-decoration-none"> Facebook</a><br>
       </div>
   </div>
</div>
</div>
    ...
    <div class="row" id="footer-credit">
      <div class="col">
        <div class="container mt-2 mb-2 text-center">
          <small>Copyright © 2025 <a href="<?php echo e(url('')); ?>" class="text-white text-decoration-none"><?php echo e(ENV('APP_NAME')); ?></a> All Rights Reserved</small>
      </div>
  </div>
</div>
</div>
...
</html><?php /**PATH /home/gamesho1/gameshop.asia/mcproject/resources/views/template/template.blade.php ENDPATH**/ ?>