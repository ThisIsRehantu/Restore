...
<nav class="navbar navbar-expand-lg d-flex fixed-top shadow">
  <div class="container-fluid">
    ...
    <div class="search-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('/user/dashboard')); ?>"></i> Dashboard</a>
          </li>
          <li class="nav-item">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamesho1/gameshop.asia/becraft/resources/views/template/index.blade.php ENDPATH**/ ?>