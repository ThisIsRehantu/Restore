    ...
    <div class="px-3 py-3">
        ...
        <div class="row mt-4">
            ...
            <div class="col-6 col-md-3 col-lg-4 mb-3">
                <div id="product-<?php echo e($nom->id); ?>" 
                     class="p-2 px-3 cursor-pointer bg-product product-list position-relative"
                     product-id="<?php echo e($nom->id); ?>" onclick="selectProduct(<?php echo e($nom->id); ?>)">
...
<style>
    /* Gaya default untuk item produk */
.bg-product {
    border-radius: 8px;
...
<script>
    function selectProduct(id) {
        ...
        let items = document.querySelectorAll('.product-list');

        // Loop untuk menghapus class 'selected' dari semua item
        items.forEach(item => {
        ...
        // Tambahkan class 'selected' pada item yang diklik
        let selectedProduct = document.getElementById(`product-${id}`);
        selectedProduct.classList.add('selected');

        // Tampilkan ikon centang
        let checkMark = document.getElementById(`check-${id}`);
								...
								<div class="col-6 col-md-3 col-lg-4">
										<div id="method-23" class="p-2 border rounded mb-3 method-list bg-light shadow-sm"  method-id="<?php echo e($p->code); ?>">
											...
											<div style="font-size: 12px;color: #718096;">
												...
												<b class="d-block"><?php echo e($p->keterangan); ?></b>
											</div>
										</div>
									</div>
									<?php endif; ?>
					...
					<div class="accordion-item border-0">
						...
						<div id="collapse-convenience-store" class="accordion-collapse collapse" aria-labelledby="heading-convenience-store" data-bs-parent="#accordionExample-2">
							<div class="accordion-body bg-payment">
								...
								<div class="col-6 col-md-3 col-lg-4">
										<div id="method-12" class="p-2 border rounded mb-3 method-list bg-light shadow-sm"  method-id="<?php echo e($p->code); ?>">
											<table class="w-100 border-bottom mb-2">
												<tr>
													<td>
														<img src="<?php echo e($p->images); ?>" alt="" class="w-75">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gamesho1/gameshop.asia/becraft/resources/views/template/order.blade.php ENDPATH**/ ?>