                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="<?php echo e(url('/data/joki')); ?>">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; <?php echo e(ENV('APP_NAME')); ?> by <a href="https://kodenstore.com/user/becraft">BECRAFT</a>
                        </div>
                    </div>
                </div>
            </footer>
...
</html><?php /**PATH /home/gamesho1/gameshop.asia/becraft/resources/views/main-admin.blade.php ENDPATH**/ ?>