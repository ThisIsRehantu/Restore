...
<head>
    ...
    <meta content="{{ !$config ? '' : $config->web_description }}" name="description" />
    <meta content="SURS" name="author" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ !$config ? '' : $config->fav_ico }}">
                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ route('datajoki') }}">
                                    <i data-feather="shopping-bag"></i>
                                    <span> Data Joki</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    <a href="{{ route('berita') }}" class="dropdown-item">Slide / Pop Up</a>
                                    <a href="{{ route('member') }}" class="dropdown-item">Pengguna</a>
                                    <a href="{{ route('method') }}" class="dropdown-item">Payment</a>
                                    <a href="{{ route('seting') }}" class="dropdown-item">Setting Web</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    ...
                                    <a href="{{ route('promo') }}" class="dropdown-item"> Flashsale</a>
                                </div>
                            </li>
                            @endauth
                        </ul> <!-- end navbar-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; Design & Developed by <a href="https://wcode.id">WCODE.ID</a>
                        </div>
                        <div class="col-md-6">
